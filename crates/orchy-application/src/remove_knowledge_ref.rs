...
pub struct RemoveKnowledgeRefCommand {
    pub org_id: String,
    pub project: String,
...
pub struct RemoveKnowledgeRef {
    store: Arc<dyn KnowledgeStore>,
}

impl RemoveKnowledgeRef {
    pub fn new(store: Arc<dyn KnowledgeStore>) -> Self {
        Self { store }
    }

    pub async fn execute(&self, cmd: RemoveKnowledgeRefCommand) -> Result<KnowledgeResponse> {
        let org_id =
